...
const Home = () => {
  ...
  if(loading){
    return <div className="absolute top-0 left-0 w-full h-full backdrop-filter backdrop-blur-sm flex justify-center items-center bg-transparent bg-opacity-50">
